  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-lg font-semibold text-slate-100">Optimized Resume</h3>
        <div className="flex items-center gap-2">
          <button
            onClick={handleCopy}
            className="flex items-center gap-2 text-sm bg-slate-700 hover:bg-slate-600 text-slate-100 font-medium py-2 px-3 rounded-lg transition-colors"
          >
            {copied ? (
              <React.Fragment>
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={() => downloadAsPDF(resumeText)}
              className="text-sm bg-sky-600 hover:bg-sky-700 text-white font-medium py-2 px-3 rounded-lg transition-colors"
            >
              Download PDF
            </button>
            <button
              onClick={() => downloadAsDocx(resumeText)}
              className="text-sm bg-emerald-600 hover:bg-emerald-700 text-white font-medium py-2 px-3 rounded-lg transition-colors"
            >
              Download DOCX
            </button>
          </div>
      ...
      <div
        className="bg-slate-900 border border-slate-700 p-4 rounded-lg prose prose-sm prose-invert max-w-none max-h-96 overflow-y-auto"
        style={{ whiteSpace: 'pre-wrap', wordWrap: 'break-word', color: 'var(--tw-text-opacity, 1)' }}
      >
        {resumeText}
      </div>
    </div>
