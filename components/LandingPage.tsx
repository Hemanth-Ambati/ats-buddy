    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-300 font-sans selection:bg-sky-200 dark:selection:bg-sky-900">
            ...
            <main className="relative z-10 container mx-auto px-6 pt-20 pb-32 text-center">
                ...
                {/* Feature Grid */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto text-left mb-32">
                    <FeatureCard
                        icon={
                    ...
                    <FeatureCard
                        ...
                        title="Cover Letters"
                        description="Generate tailored cover letters that highlight your experience and match the job tone."
                    />
                </div>
